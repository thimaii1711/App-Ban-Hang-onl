...
import com.example.appbanhangonl.activity.MeetingUserActivity;
...
//                startActivity(intents);
            ...
            if (HlsState.has("status")) {
                try {
                    ...
                    if (HlsState.getString("status").equals("HLS_STOPPED")) {
                        ...
                        releasePlayer();
                        playbackHlsUrl = null;
                        waitingLayout.setText("Chủ phòng \n đã dừng phát trực tiếp...");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (meeting != null) {
            ...
            ((TextView) view.findViewById(R.id.meetingId)).setText("Mã phòng : " + meeting.getMeetingId());
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof Activity) {
            ...
            // get meeting object from MeetingUserActivity
            meeting = ((MeetingUserActivity) mActivity).getMeeting();
        }
    }
